...
Begin VB.Form frmMain 
   ...
   Begin VB.CheckBox cmdMiniMap 
      ...
      Width           =   195
   End
   Begin DesCompresorAOLibre.uAOButton cmdCerrar 
      Height          =   375
      Left            =   6000
      TabIndex        =   11
      Top             =   360
   ...
   Begin VB.TextBox txtContra 
      ...
      Width           =   1815
   End
   Begin DesCompresorAOLibre.uAOButton cmdComprimirMaps 
      Height          =   615
      Left            =   4080
      TabIndex        =   1
      Top             =   960
   ...
   Begin MSComctlLib.ProgressBar StatusBar 
      ...
      Scrolling       =   1
   End
   Begin DesCompresorAOLibre.uAOButton cmdDescomprimirMaps 
      Height          =   615
      Left            =   4080
      TabIndex        =   3
      Top             =   1560
      ...
      EndProperty
   End
   Begin DesCompresorAOLibre.uAOButton cmdParcheMaps 
      Height          =   615
      Left            =   4080
      TabIndex        =   5
      Top             =   2160
      ...
      EndProperty
   End
   Begin DesCompresorAOLibre.uAOButton cmdAplicarMaps 
      Height          =   615
      Left            =   4080
      TabIndex        =   7
      Top             =   2760
      ...
      EndProperty
   End
   Begin DesCompresorAOLibre.uAOButton cmdComprimirGrh 
      Height          =   615
      Left            =   1800
      TabIndex        =   0
      Top             =   960
      ...
      EndProperty
   End
   Begin DesCompresorAOLibre.uAOButton cmdDescomprimirGrh 
      Height          =   615
      Left            =   1800
      TabIndex        =   2
      Top             =   1560
      ...
      EndProperty
   End
   Begin DesCompresorAOLibre.uAOButton cmdParcheGrh 
      Height          =   615
      Left            =   1800
      TabIndex        =   4
      Top             =   2160
      ...
      EndProperty
   End
   Begin DesCompresorAOLibre.uAOButton cmdAplicarGrh 
      Height          =   615
      Left            =   1800
      TabIndex        =   6
      Top             =   2760
    ...
    If SourcePath <> vbNullString Then
        If GuardarComprimido = True Then
            ...
            If FileExist(OutputPath, vbNormal) Then
                If MsgBox("El archivo de Graficos.AO ya se encuentra comprimido. ¿Desea reemplazarlo?", vbYesNo, "Atencion") = vbNo Then _
                    Exit Sub
            End If
...
On Error Resume Next
    ...
    If SourcePath <> vbNullString Then
        If GuardarComprimido("Indique donde será guardado Mapas.AO", "Mapas (*.AO)" & vbNullChar & "*.AO" & vbNullChar & "Todos los archivos" & vbNullChar & "*.*") = True Then
        
            OutputPath = IniPathD & CompressFileD
            
            'Check if the version already exists
            If FileExist(OutputPath, vbNormal) Then
                If MsgBox("El archivo de Mapas.AO ya se encuentra comprimido. ¿Desea reemplazarlo?", vbYesNo, "Atencion") = vbNo Then _
                    Exit Sub
            End If
...
On Error Resume Next
    ...
    If AbrirComprimido("Seleccione el archivo Mapas.AO", "Graficos (*.AO)" & vbNullChar & "*.AO" & vbNullChar & "Todos los archivos" & vbNullChar & "*.*") = True Then
...
On Error Resume Next
    ...
    If AbrirComprimido("Seleccione el antiguo archivo de Graficos.AO") = True Then ' viejo
        OldResourcePath = IniPath & CompressFile
        If AbrirComprimido("Seleccione el nuevo archivo de Graficos.AO") = True Then ' nuevo
...
On Error Resume Next
    ...
    If AbrirComprimido("Seleccione el antiguo archivo de Mapas.AO") = True Then ' viejo
        OldResourcePath = IniPath & CompressFile
        If AbrirComprimido("Seleccione el nuevo archivo de Mapas.AO") = True Then ' nuevo
            NewResourcePath = IniPath & CompressFile
